...
**GitHub repo:** `harbor-kitchen-restaurant` (standalone repository — own `origin`, branches, commits, and secrets)
...
| Secret | Purpose |
|--------|---------|
| `VITE_API_BASE_URL` | Worker URL (e.g. `https://restaurant-website-api.your-subdomain.workers.dev`) |
